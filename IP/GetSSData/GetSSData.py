...
AD_SS_LO4 = Int('AD_SS_LO4')
AD_SS_LO4_next = Int('AD_SS_LO4_next')
AD_SS_HI8 = Int('AD_SS_HI8')
AD_SS_HI8_next = Int('AD_SS_HI8_next')
SP_ADDR = Int('SP_ADDR')
SP_ADDR_next = Int('SP_ADDR_next')
SP_BIT = Int('SP_BIT')
SP_BIT_next = Int('SP_BIT_next')
piyaw = Real('piyaw')
piyaw_next = Real('piyaw_next')
royaw = Real('royaw')
royaw_next = Real('royaw_next')
VER_chnl = Array('chnl', IntSort(), IntSort())
VER_chnl_next = Array('chnl_next', IntSort(), IntSort())
flgSp = Int('flgSp')
flgSp_next = Int('flgSp_next')
######
SP = Int('SP')
SP_next = Int('SP_next')
hi8 = BitVec('hi8', 16)
