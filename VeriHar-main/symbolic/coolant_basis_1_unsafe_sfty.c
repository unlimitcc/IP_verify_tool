#include "VeriHar-main/include/coolant_basis_1_unsafe_sfty.h"
#include <stdlib.h>
#include <time.h>
...
int error, tempDisplay, warnLED, warnLight, init;
int timer = 0;
int counter = 0;

void display(int tempdiff, int warning, void *pIp)
{
	coolant_basis_1_unsafe_sfty *p = (coolant_basis_1_unsafe_sfty*)pIp;
